...
Store.prototype = {
    ...
    getGenericTopLevelSBOL: getGenericTopLevelSBOL,
...
function getGenericTopLevelSBOL(prefix, uri, callback) {
    ...
    getSBOL('genericTopLevel', this.storeUrl, this.auth, prefix, uri, function(err, sbol) {
